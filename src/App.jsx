...
const FUNDS = [
  {
    id: "yc",
    name: "Y Combinator",
    thesis: "Stage-agnostic accelerator. Technical founders building software products across all sectors. 55% of latest batch uses Supabase.",
    aum: "N/A (accelerator)",
    year: "Ongoing",
    stageFocus: "Pre-seed",
    companies: [
      { name: "Stripe", arch: "api-platform", stage: "Seed" },
      { name: "Airbnb", arch: "marketplace", stage: "Seed" },
      { name: "Brex", arch: "full-stack-saas", stage: "Seed" },
      { name: "Retool", arch: "full-stack-saas", stage: "Seed" },
      { name: "PostHog", arch: "full-stack-saas", stage: "Seed" },
      { name: "Cal.com", arch: "full-stack-saas", stage: "Seed" },
      { name: "Supabase", arch: "api-platform", stage: "Seed" },
      { name: "Resend", arch: "api-platform", stage: "Seed" },
      { name: "Loops", arch: "full-stack-saas", stage: "Seed" },
      { name: "Vercel", arch: "api-platform", stage: "Seed" },
      { name: "Loom", arch: "full-stack-saas", stage: "Seed" },
      { name: "Zapier", arch: "full-stack-saas", stage: "Seed" },
      { name: "GitLab", arch: "api-platform", stage: "Seed" },
      { name: "Metatext AI", arch: "ai-native", stage: "Pre-seed" },
      { name: "Helicone", arch: "ai-native", stage: "Seed" },
      { name: "Autoblocks", arch: "ai-native", stage: "Seed" },
      { name: "Baseten", arch: "ai-native", stage: "Seed" },
      { name: "Pylon", arch: "full-stack-saas", stage: "Seed" },
      { name: "Graphite", arch: "full-stack-saas", stage: "Seed" },
      { name: "Mintlify", arch: "full-stack-saas", stage: "Seed" },
    ]
  },
  {
    id: "a16z-infra",
  ...
  },
  {
    id: "a16z-apps",
    name: "a16z Apps",
    thesis: "Consumer, enterprise SaaS, and fintech applications. $1B fund (2024). Mix of B2C and B2B with varied backend needs.",
    aum: "$1.0B",
    year: "2024",
    stageFocus: "Series A",
    companies: [
      { name: "Notion", arch: "full-stack-saas", stage: "Series A" },
      { name: "Clubhouse", arch: "mobile-consumer", stage: "Series A" },
      { name: "Coda", arch: "full-stack-saas", stage: "Series A" },
      { name: "Substack", arch: "full-stack-saas", stage: "Series A" },
      { name: "Navan", arch: "full-stack-saas", stage: "Series B+" },
      { name: "Greenlight", arch: "mobile-consumer", stage: "Series A" },
      { name: "Ramp", arch: "full-stack-saas", stage: "Series A" },
      { name: "Mercury", arch: "full-stack-saas", stage: "Series A" },
      { name: "Descript", arch: "full-stack-saas", stage: "Series A" },
      { name: "Lunchclub", arch: "marketplace", stage: "Seed" },
      { name: "Poparazzi", arch: "mobile-consumer", stage: "Seed" },
      { name: "Beacons", arch: "full-stack-saas", stage: "Seed" },
      { name: "Stytch", arch: "api-platform", stage: "Series A" },
      { name: "Skio", arch: "marketplace", stage: "Seed" },
      { name: "Composer", arch: "full-stack-saas", stage: "Seed" },
      { name: "Posh", arch: "ai-native", stage: "Seed" },
      { name: "Even", arch: "mobile-consumer", stage: "Series A" },
      { name: "Yassir", arch: "marketplace", stage: "Series A" },
      { name: "Facet", arch: "full-stack-saas", stage: "Series A" },
      { name: "Captions", arch: "ai-native", stage: "Series A" },
    ]
  },
  {
    id: "a16z-games",
    name: "a16z Games",
    thesis: "Gaming studios, gaming infrastructure, and interactive entertainment. $600M fund (2024). Mix of content studios and gaming tech.",
    aum: "$600M",
    year: "2024",
    stageFocus: "Series A",
    companies: [
      { name: "Roblox", arch: "api-platform", stage: "Series B+" },
      { name: "Overwolf", arch: "api-platform", stage: "Series B+" },
      { name: "Azra Games", arch: "mobile-consumer", stage: "Series A" },
      { name: "Mainframe Industries", arch: "mobile-consumer", stage: "Seed" },
      { name: "Theorycraft Games", arch: "mobile-consumer", stage: "Seed" },
      { name: "Singularity 6", arch: "mobile-consumer", stage: "Series A" },
      { name: "Legendary Play", arch: "mobile-consumer", stage: "Seed" },
      { name: "Metatheory", arch: "mobile-consumer", stage: "Series A" },
      { name: "Limit Break", arch: "protocol-infra", stage: "Series A" },
      { name: "Proof of Play", arch: "protocol-infra", stage: "Seed" },
      { name: "Irreverent Labs", arch: "mobile-consumer", stage: "Seed" },
      { name: "Neon Machine", arch: "mobile-consumer", stage: "Seed" },
      { name: "Pragma", arch: "api-platform", stage: "Seed" },
      { name: "Stardust", arch: "api-platform", stage: "Seed" },
      { name: "Fenix Games", arch: "marketplace", stage: "Seed" },
      { name: "Horizon Blockchain", arch: "protocol-infra", stage: "Series A" },
      { name: "Mythical Games", arch: "mobile-consumer", stage: "Series A" },
      { name: "Sandbox VR", arch: "hardware-iot", stage: "Series A" },
      { name: "Ready Player Me", arch: "api-platform", stage: "Series A" },
      { name: "Playable Worlds", arch: "mobile-consumer", stage: "Seed" },
    ]
  },
  {
    id: "a16z-crypto",
    name: "a16z Crypto",
    thesis: "DeFi protocols, blockchain infrastructure, DAOs, Web3 gaming, NFT platforms. ~$2B Fund V planned (2025).",
    aum: "$2.0B",
    year: "2025",
    stageFocus: "Seed",
    companies: [
      { name: "Uniswap", arch: "protocol-infra", stage: "Seed" },
      { name: "Solana", arch: "protocol-infra", stage: "Seed" },
      { name: "dYdX", arch: "protocol-infra", stage: "Seed" },
      { name: "Phantom", arch: "mobile-consumer", stage: "Seed" },
      { name: "OpenSea", arch: "marketplace", stage: "Seed" },
      { name: "Sound.xyz", arch: "full-stack-saas", stage: "Seed" },
      { name: "Farcaster", arch: "full-stack-saas", stage: "Seed" },
      { name: "LayerZero", arch: "protocol-infra", stage: "Series A" },
      { name: "EigenLayer", arch: "protocol-infra", stage: "Seed" },
      { name: "Worldcoin", arch: "protocol-infra", stage: "Series A" },
      { name: "Alchemy", arch: "api-platform", stage: "Series A" },
      { name: "Goldfinch", arch: "protocol-infra", stage: "Seed" },
      { name: "Royal", arch: "marketplace", stage: "Seed" },
      { name: "Near Protocol", arch: "protocol-infra", stage: "Seed" },
      { name: "Flowcarbon", arch: "protocol-infra", stage: "Seed" },
      { name: "Yuga Labs", arch: "marketplace", stage: "Series A" },
      { name: "Lit Protocol", arch: "protocol-infra", stage: "Seed" },
      { name: "Anoma", arch: "protocol-infra", stage: "Seed" },
      { name: "Aztec", arch: "protocol-infra", stage: "Series A" },
      { name: "Valora", arch: "mobile-consumer", stage: "Series A" },
    ]
  },
  {
    id: "a16z-dynamism",
    name: "a16z American Dynamism",
    thesis: "Defense, public safety, gov tech, critical infrastructure. $1.18B (2025). Hardware-adjacent, often classified/custom infra.",
    aum: "$1.18B",
    year: "2025",
    stageFocus: "Series A",
    companies: [
      { name: "Anduril", arch: "hardware-iot", stage: "Series B+" },
      { name: "Hadrian", arch: "hardware-iot", stage: "Series A" },
      { name: "Apex Space", arch: "hardware-iot", stage: "Seed" },
      { name: "Castelion", arch: "hardware-iot", stage: "Series A" },
      { name: "Firestorm", arch: "hardware-iot", stage: "Seed" },
      { name: "Applied Intuition", arch: "full-stack-saas", stage: "Series B+" },
      { name: "Saronic", arch: "hardware-iot", stage: "Series A" },
      { name: "Flock Safety", arch: "full-stack-saas", stage: "Series A" },
      { name: "Ready Robotics", arch: "hardware-iot", stage: "Series A" },
      { name: "Vannevar Labs", arch: "full-stack-saas", stage: "Series A" },
      { name: "Epirus", arch: "hardware-iot", stage: "Series A" },
      { name: "Gecko Robotics", arch: "hardware-iot", stage: "Series A" },
      { name: "Saildrone", arch: "hardware-iot", stage: "Series B+" },
      { name: "Skydio", arch: "hardware-iot", stage: "Series B+" },
      { name: "Shield AI", arch: "hardware-iot", stage: "Series B+" },
      { name: "Govly", arch: "full-stack-saas", stage: "Seed" },
      { name: "Palantir (co-inv)", arch: "data-analytics", stage: "Series B+" },
      { name: "Sierra Space", arch: "hardware-iot", stage: "Series B+" },
      { name: "Hermeus", arch: "hardware-iot", stage: "Series A" },
      { name: "K2 Space", arch: "hardware-iot", stage: "Seed" },
    ]
  },
  {
    id: "boldstart",
  ...
  {
    id: "sequoia",
    name: "Sequoia Capital (US Early)",
    thesis: "Multi-sector early stage, strong lean toward AI/ML and B2B SaaS. Evergreen fund structure since 2022. Already an AWS Activate Provider.",
    aum: "Evergreen",
    year: "2022+",
    stageFocus: "Seed",
    companies: [
      { name: "Stripe", arch: "api-platform", stage: "Seed" },
      { name: "Linear", arch: "full-stack-saas", stage: "Seed" },
      { name: "Figma", arch: "full-stack-saas", stage: "Seed" },
      { name: "Notion", arch: "full-stack-saas", stage: "Seed" },
      { name: "Scale AI", arch: "ai-native", stage: "Seed" },
      { name: "Hugging Face", arch: "ai-native", stage: "Series A" },
      { name: "Harvey AI", arch: "ai-native", stage: "Series A" },
      { name: "Arc (browser)", arch: "mobile-consumer", stage: "Seed" },
      { name: "Zip (procure)", arch: "full-stack-saas", stage: "Series A" },
      { name: "Coda", arch: "full-stack-saas", stage: "Seed" },
      { name: "Watershed", arch: "full-stack-saas", stage: "Series A" },
      { name: "Vanta", arch: "full-stack-saas", stage: "Seed" },
      { name: "Wiz", arch: "full-stack-saas", stage: "Series A" },
      { name: "Glean", arch: "ai-native", stage: "Series A" },
      { name: "Cohere", arch: "ai-native", stage: "Series A" },
      { name: "Everlane", arch: "marketplace", stage: "Series A" },
      { name: "Nubank", arch: "full-stack-saas", stage: "Seed" },
      { name: "Klarna", arch: "full-stack-saas", stage: "Series A" },
      { name: "Reddit", arch: "full-stack-saas", stage: "Series A" },
      { name: "Replit", arch: "full-stack-saas", stage: "Seed" },
    ]
  },
];
